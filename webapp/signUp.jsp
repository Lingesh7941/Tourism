      ...
      <form action="signUpServlet" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" name="passcode" placeholder="Enter your password" required>
          </div>
          <div class="input-box">
            <span class="details">Confirm Password</span>
            <input type="text" name="cpasscode" placeholder="Confirm your password" required>
          </div>
        </div>
        <div class="gender-details">
         ...
         <div class="button">
          ...
          <!-- <a href="signUp.jsp" type="button">Register</a> -->
      </div>
      </form>
    </div>
  </div>
